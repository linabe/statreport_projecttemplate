...
The median age (IQR) is `r rsdata %>% summarise(med = dF(median(shf_age), dig = 1),
...
`r rsdata %>% summarise(med = dF(median(sos_outtime_death / 365.25 * 12), dig = 1),
                                   ...
                                   `r rsdata %>% summarise(sumpy = dF(sum(sos_outtime_death) / 365.25, dig = 0)) %>%
